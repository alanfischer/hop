...
struct sphere {
	...
	sphere& set(const sphere& s) { origin = s.origin; radius = s.radius; return *this; }
	sphere& set(const vec3<T>& o, T r) { origin = o; radius = r; return *this; }
	sphere& reset() { origin.reset(); radius = T{}; return *this; }
